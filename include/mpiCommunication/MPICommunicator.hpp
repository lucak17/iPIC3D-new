...
// communicate<Mask>(data, nx, ny, nz, H, cart)
//   - data: pointer to your flat buffer of size (nx+2H)*(ny+2H)*(nz+2H)
//   - nx,ny,nz: interior sizes
//   - H: halo width (assumed 1 here, but generalizes)
//   - cart: a 3D Cartesian MPI_Comm with dims set up
template<int Mask>
